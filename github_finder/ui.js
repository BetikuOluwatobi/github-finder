class UI {
      ...
      <div class='card card-body mb-3'>
        <div class='row'>
          <div class='col-md-3 mb-3'>
            ...
            <a href="${user.html_url}" class="btn btn-primary btn-block" target='_blank'>Check Profile</a>
          </div>
          <div class='col-md-9'>
            ...
            <li class='list-group-item'>Open To Work: ${user.hireable}</li>
    ...
    showRepos(repos) {
            ...
            repos.forEach((repo) => {
                output += `
              <div class='card card button mb-2 ml-3 mr-3'>
                <div class='row'>
                  <div class='col-md-6'>
